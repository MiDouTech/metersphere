...
> **【已归档】2026-07**：本地启停与 `dev/docker-compose` 已迁至 [`legacy/local-dev/`](../../legacy/local-dev/README.md)。团队默认云开发；线上部署以 [`deploy/README.md`](../../deploy/README.md) 为准。  
> 下文中的 `start.ps1`、`dev/`、`deploy/nacos/dev` 等路径为历史描述，请对照归档目录理解。
