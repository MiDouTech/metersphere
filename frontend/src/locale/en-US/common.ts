export default {
  ...
  'common.reset': 'Reset',
  'common.retry': 'Retry',
  'common.copyDiagnostic': 'Copy diagnostics',
  'common.copyFailed': 'Copy failed',
  'common.errorCode': 'Error code',
  'common.requestId': 'Request ID',
  'common.loadFailedTitle': 'Unable to load content',
  'common.loadFailedMessage': 'Content is temporarily unavailable. Please try again.',
  'common.end': 'End',
  ...
  'common.autoSave.saved': 'Saved',
  'common.autoSave.dirty': 'Unsaved changes',
  'common.autoSave.saveFailed': 'Save failed, please retry',
  'common.autoSave.retry': 'Retry',
  'common.autoSave.lockedByOther': 'Someone else is editing',
  'common.autoSave.lockFailed': 'Failed to acquire edit lock',
  'common.autoSave.leaveWithError': 'Save failed. Unsaved changes may be lost if you leave',
  'common.autoSave.nothingToUndo': 'Nothing to undo',
  'common.autoSave.nothingToRedo': 'Nothing to redo',
  'common.autoSave.undoSuccess': 'Undone',
  'common.autoSave.redoSuccess': 'Redone',
  'common.leave': 'Leave',
  ...
  'common.missingPermission': 'Missing permission',
  'common.backToPrevious': 'Back to previous page',
