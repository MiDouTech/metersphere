...
export default {
  message: {
    ...
    'menu.testAsset': 'Test Assets',
    'menu.testAssetShort': 'Assets',
    'menu.testAsset.documents': 'Business Documents',
    'menu.testAsset.versions': 'Asset Versions',
    'menu.testAsset.relations': 'Traceability',
    'menu.testAsset.cases': 'Case Assets',
    'menu.testAsset.datasets': 'Test Data',
    'menu.testAsset.environments': 'Environments',
    'menu.testAsset.commonSteps': 'Common Steps',
    'menu.testAsset.apis': 'API Assets',
    'menu.testAsset.evidence': 'Evidence',
    'menu.testAsset.bugs': 'Defects',
    ...
    'menu.projectManagement.projectList': 'Projects',
    ...
    'menu.settings.system.permissionControl': 'Permission Control',
    ...
    'system.agentIntegration.packageTitle': 'Agent Package Management',
    'system.agentIntegration.packageDescription':
      'Packages are uploaded independently to platform storage and are not bundled with MeterSphere backend builds.',
    'system.agentIntegration.packageNotice':
      'Only one version can be active per OS and architecture. Internal users download the active version.',
    'system.agentIntegration.packageUpload': 'Upload Package',
    'system.agentIntegration.packageEmpty': 'No Agent package has been uploaded',
    'system.agentIntegration.packageVersion': 'Version',
    'system.agentIntegration.packageVersionRequired': 'Package version is required',
    'system.agentIntegration.packagePlatform': 'Platform',
    'system.agentIntegration.packageOs': 'Operating System',
    'system.agentIntegration.packageArch': 'Architecture',
    'system.agentIntegration.packageFile': 'File Name',
    'system.agentIntegration.packageSize': 'Size',
    'system.agentIntegration.packageDownloads': 'Downloads',
    'system.agentIntegration.packageStatus': 'Status',
    'system.agentIntegration.packageActivateAfterUpload': 'Activate after upload',
    'system.agentIntegration.packageDrop': 'Click or drag the MeterSphere Agent ZIP here',
    'system.agentIntegration.packageLimit': 'Only ZIPs produced by the project packaging script, up to 500 MB',
    'system.agentIntegration.packageFileRequired': 'Select an Agent ZIP package',
    'system.agentIntegration.packageUploadSuccess': 'Agent package uploaded',
    'system.agentIntegration.packageDeleteConfirm':
      'Delete Agent package {version}? The file will also be removed from storage.',
    ...sys,
    ...localeSettings,
    ...result,
    ...common,
