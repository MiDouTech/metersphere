...
export default {
  message: {
    ...
    'system.agentIntegration.searchToken': 'Search token name or user',
    'system.agentIntegration.tokenName': 'Token Name',
    'system.agentIntegration.tokenNameRequired': 'Token name is required',
    'system.agentIntegration.userId': 'Bound User',
    'system.agentIntegration.userIdRequired': 'Enter platform user ID or WeCom UserID',
    'system.agentIntegration.userIdPlaceholder': 'Platform user ID or WeCom UserID',
    'system.agentIntegration.defaultProjectId': 'Default Project ID',
    ...
    'system.agentIntegration.mcpTitle': 'MCP config / credential delivery',
    'system.agentIntegration.mcpDesc':
      'Download the MCP package, fill in Token and project, then copy Cursor mcp.json. Runtime stays on the Agent side (Node); the platform only delivers config and the bundle.',
    'system.agentIntegration.mcpVersion': 'Bundle version {version}',
    'system.agentIntegration.mcpUnavailable': 'MCP bundle unavailable; ask admin to repack and redeploy',
    'system.agentIntegration.mcpDownload': 'Download MCP package',
    'system.agentIntegration.mcpDownloadSuccess': 'MCP package download started',
    'system.agentIntegration.mcpCopyConfig': 'Copy mcp.json',
    'system.agentIntegration.mcpCopySuccess': 'mcp.json copied to clipboard',
    'system.agentIntegration.mcpBaseUrl': 'Base URL (MS_BASE_URL)',
    'system.agentIntegration.mcpToken': 'Agent Token',
    'system.agentIntegration.mcpTokenPlaceholder': 'Paste after create, or use Copy into MCP',
    'system.agentIntegration.mcpTestPlanId': 'Default test plan ID (optional)',
    'system.agentIntegration.mcpDistPath': 'MCP entry path (args)',
    'system.agentIntegration.mcpDistPathPlaceholder': 'Use absolute path .../metersphere-mcp/dist/index.js after unzip',
    'system.agentIntegration.mcpHint':
      'After unzip run npm install --omit=dev; set args to an absolute path and restart Cursor. Never commit tokens to Git.',
    'system.agentIntegration.mcpScopeHelp': 'Common scopes',
    'system.agentIntegration.scopeAgentAll': 'Full agent loop',
    'system.agentIntegration.scopeBug': 'Bug read / write',
    'system.agentIntegration.scopeCase': 'Case read/submit and plan/review write',
    'system.agentIntegration.copyTokenAndMcp': 'Copy into MCP config',
