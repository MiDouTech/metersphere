...
export default {
  message: {
    ...
    'system.agentIntegration.userId': '关联用户',
    'system.agentIntegration.userIdRequired': '请输入平台用户 ID 或企微 UserID',
    'system.agentIntegration.userIdPlaceholder': '支持平台用户ID或企微UserID',
    'system.agentIntegration.defaultProjectId': '默认项目 ID',
    ...
    'system.agentIntegration.mcpTitle': 'MCP 配置 / 凭证下发',
    'system.agentIntegration.mcpDesc':
      '下载 MCP 装配包，填写 Token 与项目后一键复制 Cursor mcp.json。运行时在 Agent 侧（Node），平台只负责配置与包分发。',
    'system.agentIntegration.mcpVersion': '当前包版本 {version}',
    'system.agentIntegration.mcpUnavailable': 'MCP 包暂不可用，请联系管理员重新打包部署',
    'system.agentIntegration.mcpDownload': '下载 MCP 包',
    'system.agentIntegration.mcpDownloadSuccess': '开始下载 MCP 包',
    'system.agentIntegration.mcpCopyConfig': '复制 mcp.json',
    'system.agentIntegration.mcpCopySuccess': 'mcp.json 已复制到剪贴板',
    'system.agentIntegration.mcpBaseUrl': '平台地址 MS_BASE_URL',
    'system.agentIntegration.mcpToken': 'Agent Token',
    'system.agentIntegration.mcpTokenPlaceholder': '创建 Token 后粘贴，或点「复制并填入 MCP」',
    'system.agentIntegration.mcpTestPlanId': '默认测试计划 ID（可选）',
    'system.agentIntegration.mcpDistPath': 'MCP 入口路径（args）',
    'system.agentIntegration.mcpDistPathPlaceholder': '解压后请改为本机绝对路径 .../metersphere-mcp/dist/index.js',
    'system.agentIntegration.mcpHint':
      '解压后执行 npm install --omit=dev；将 args 改为绝对路径后重启 Cursor。Token 仅本地配置，勿提交到 Git。',
    'system.agentIntegration.mcpScopeHelp': '常用 Scope',
    ...
    'system.agentIntegration.copyTokenAndMcp': '复制并填入 MCP 配置',
