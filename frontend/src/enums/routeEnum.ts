...
export enum CaseManagementRouteEnum {
  ...
  CASE_MANAGEMENT_AUTOMATION_EXECUTION = 'caseManagementAutomationExecution',
...
export enum TestAssetRouteEnum {
  ...
  TEST_ASSET_CASE_DETAIL = 'testAssetCaseDetail',
...
export enum SettingRouteEnum {
  ...
  SETTING_SYSTEM_PERMISSION_CONTROL_ROLE_CREATE = 'settingSystemPermissionControlRoleCreate',
  SETTING_SYSTEM_PERMISSION_CONTROL_ROLE_DETAIL = 'settingSystemPermissionControlRoleDetail',
