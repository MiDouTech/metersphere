export default {
  ...
  'organization.member.batchActionRemove': 'Remove from organization',
  'organization.member.batchRemoveTip': 'Are you sure to remove {number} selected members?',
  'organization.member.batchRemoveContent': 'When removed, organization permissions are lost',
