export default {
  ...
  'caseManagement.featureCase.xmindDeleteTitle': 'Delete "{name}"?',
  'caseManagement.featureCase.xmindDeleteContent': 'Deleted files cannot be recovered',
  'caseManagement.featureCase.xmindUploadTodo': 'Upload API is not ready yet. Please try again later',
  'caseManagement.featureCase.xmindUploadSuccess': 'Uploaded',
  ...
  'caseManagement.featureCase.createFolder': 'Create folder',
  'caseManagement.featureCase.createFolderSuccess': 'Folder created',
  'caseManagement.featureCase.addFolderTip': 'Enter folder name and press Enter',
  ...
  'caseManagement.featureCase.importHubSelectAll': 'All cases',
  ...
  'caseManagement.featureCase.precedingCase': 'Preceding Cases',
  ...
  'caseManagement.featureCase.caseListTab': 'Case list',
  'caseManagement.featureCase.caseDetailTab': 'Case detail',
  'caseManagement.featureCase.prevCase': 'Previous',
  'caseManagement.featureCase.nextCase': 'Next',
  'caseManagement.featureCase.saveAndNextCase': 'Save & Next',
  'caseManagement.featureCase.lastCaseTip': 'This is the last case',
  'caseManagement.featureCase.batchEditExecResult': 'Batch update execution result',
  'caseManagement.featureCase.batchChangeExecutor': 'Batch update executor',
  'caseManagement.featureCase.requestExecutorRequired': 'Please select an executor',
  'caseManagement.featureCase.tableColumnExecutor': 'Executor',
  'caseManagement.featureCase.tableColumnLastExecutor': 'Last executor',
  'caseManagement.featureCase.personalProgress': 'Personal progress',
  'caseManagement.featureCase.execResult': 'Execution result',
  'caseManagement.featureCase.stepAttachment': 'Step attachment',
