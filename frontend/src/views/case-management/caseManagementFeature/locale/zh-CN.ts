export default {
  ...
  'caseManagement.featureCase.importFromDefaultProject': '从用例资产导入',
  'caseManagement.featureCase.importExcelTab': '从 Excel 导入',
  'caseManagement.featureCase.importHubTab': '从用例资产导入',
  'caseManagement.featureCase.importHubTip': '从用例资产复制为当前项目用例，并记录资产血缘。',
  ...
  'caseManagement.featureCase.importHubDisabledCurrent': '当前项目不可作为资产来源',
  'caseManagement.featureCase.importHubTreeFail': '加载用例资产失败',
