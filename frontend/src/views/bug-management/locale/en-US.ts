export default {
  bugManagement: {
    ...
    automationExecution: {
      ...
      artifactStatus: 'Evidence status',
      evidence: 'Screenshot evidence',
      noEvidence: 'No persisted screenshot evidence',
      caseName: 'Case name',
      result: 'Result',
      error: 'Error',
      ...
      executionModeRunner: 'Platform Runner',
      executionModeAgent: 'Agent',
      executionAgent: 'Execution Agent',
      executionAgentPlaceholder: 'Select WorkBuddy, Cursor, or Codex',
      executionAgentRequired: 'Select a configured and available Agent',
      ...
      snapshotHash: 'Scope snapshot hash',
      ...
      runnerPlaceholder:
        'The Browser Runner executes through leases and events; use its controlled browser for manual login.',
