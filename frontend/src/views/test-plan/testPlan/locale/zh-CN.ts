export default {
  ...
  'testPlan.plan': '测试计划',
  'testPlan.planTip': '编辑并保存测试计划文档；可重置为标准章节模板',
  ...
  'testPlan.document.title': '测试计划文档',
  'testPlan.document.contentSection': '文档正文',
  'testPlan.document.editTip': '可编辑保存测试计划文档，支持重置为标准章节模板',
  'testPlan.document.readonlyTip': '当前计划已归档或无编辑权限，仅可预览与导出',
  ...
  'testPlan.document.resetDone': '已恢复为模板，请点击保存以写入服务器',
};
