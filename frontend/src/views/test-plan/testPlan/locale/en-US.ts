export default {
  ...
  'testPlan.document.title': 'Test Plan Document',
  'testPlan.document.contentSection': 'Document Body',
  'testPlan.document.editTip': 'Edit and save the test plan document; you can reset to the standard section template',
  'testPlan.document.readonlyTip': 'Archived or no edit permission — preview and export only',
