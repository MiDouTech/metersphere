...
public class ProjectService {
    ...
    public List<Project> getUserProject(String organizationId, String userId) {
        ...
        //查询用户当前的项�? 如果存在默认排在第一�?        User user = baseUserMapper.selectById(userId);
        String projectId;
        ...
        userRoleRelationExample.createCriteria().andUserIdEqualTo(userId).andRoleIdEqualTo(InternalUserRole.ADMIN.getValue());
