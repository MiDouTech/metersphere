...
public class DebugListener {
    ...
    @KafkaListener(
            id = DEBUG_CONSUME_ID,
            topics = "#{@kafkaTopicService.apiReportDebugTopic()}",
            groupId = "#{@kafkaTopicService.consumerGroup(T(io.metersphere.api.listener.DebugListener).DEBUG_CONSUME_ID) + '_' + '${random.uuid}'}")
