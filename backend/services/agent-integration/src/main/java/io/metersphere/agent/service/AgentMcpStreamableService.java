...
public class AgentMcpStreamableService {
    ...
    private List<Map<String, Object>> tools() {
        return List.of(
                tool("metersphere.functional.search", "Search functional test cases", AgentTokenScope.FUNCTIONAL_READ,
                ...
                tool("metersphere.functional.modules", "List functional case modules by project", AgentTokenScope.FUNCTIONAL_READ,
                        objectSchema(Map.of("projectId", stringSchema()), List.of("projectId"))),
                tool("metersphere.functional.submit", "Submit functional case execution result", AgentTokenScope.FUNCTIONAL_SUBMIT,
                        Map.of("type", "object", "additionalProperties", true)),
                tool("metersphere.functional.module.create", "Create functional case module", AgentTokenScope.CASE_WRITE,
                        Map.of("type", "object", "additionalProperties", true)),
                tool("metersphere.functional.case.create", "Create functional case", AgentTokenScope.CASE_WRITE,
                        Map.of("type", "object", "additionalProperties", true)),
                tool("metersphere.functional.case.batch_create", "Batch create functional cases", AgentTokenScope.CASE_WRITE,
                        Map.of("type", "object", "additionalProperties", true)),
